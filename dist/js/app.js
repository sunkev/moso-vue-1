...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchProfileItems: function fetchProfileItems() {
            var _this = this;

            axios.get('/api/v1/profileitem').then(function (response) {
                _this.profileitems = response.data;
            });
        },
        fetchProgressBars: function fetchProgressBars() {
            var _this2 = this;

            axios.get('/api/v1/progressbar').then(function (response) {
                _this2.progressbars = response.data;
            });
        },
        fetchBioItems: function fetchBioItems() {
            var _this3 = this;

            axios.get('/api/v1/bioitem').then(function (response) {
                _this3.bioitems = response.data;
            });
        },
        fetchInformationItems: function fetchInformationItems() {
            var _this4 = this;

            axios.get('/api/v1/informationitem').then(function (response) {
                _this4.informationitems = response.data;
            });
        },
        fetchContactItems: function fetchContactItems() {
            var _this5 = this;

            axios.get('/api/v1/contactitem').then(function (response) {
                _this5.contactitems = response.data;
            });
        },
        fetchSocialIcons: function fetchSocialIcons() {
            var _this6 = this;

            axios.get('/api/v1/socialicon').then(function (response) {
                _this6.socialicons = response.data;
            });
        }
    }
});
      ...
      _c("div", { staticClass: "lg-5 xl-4 profile-widgets" }, [
          ...
          _c(
            ...
            [
              _c(
                ...
                _vm._l(_vm.profileitems, function(profileitem) {
                  return _c("profile-item", {
                    key: profileitem.id,
                    attrs: {
                      link: profileitem.link,
                      "link-class": profileitem.linkclass,
                      svg: profileitem.svg,
        ...
        _c("div", { staticClass: "widget" }, [
          ...
          _c(
            ...
            { staticClass: "widget__body" },
            [
              _vm._l(_vm.progressbars, function(progressbar) {
                return _c("moso-progressbar", {
                  key: progressbar.id,
                  attrs: {
      ...
      _c("div", { staticClass: "lg-7 xl-8" }, [
        _c("div", { staticClass: "widget" }, [
          ...
          _c(
            ...
            [
              _vm._l(_vm.bioitems, function(item) {
                return _c("div", {
                  key: item.id,
                  staticClass: "bio",
              ...
              _vm._v(" "),
              _vm._l(_vm.informationitems, function(item) {
                return _c(
                  "div",
                  { key: item.id, staticClass: "personal-information" },
                  [
                    ...
                    _c("div", { staticClass: "column" }, [
                      ...
                      _c(
                        "div",
                        { staticClass: "column-item column-item--right" },
                        [_vm._v(_vm._s(item.nationality))]
                      )
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "column" }, [
                    ...
                    _c("div", { staticClass: "column" }, [
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "a",
                            { attrs: { href: item.url, title: item.url } },
              ...
              _vm._v(" "),
              _vm._l(_vm.contactitems, function(item) {
                return _c(
                  "div",
                  { key: item.id, staticClass: "contact-information" },
                  [
