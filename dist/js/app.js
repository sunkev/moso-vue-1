...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Atom Dark theme for Hyper")]), _vm._v(", I decided to create one that should look fine on almost any dark theme. It's customisable, so if you want to change the colors, the sourcecode is available on GitHub for you to fork and hack.")])])], 1)])])]), _vm._v(" "), _c('div', {
    staticClass: "row resume"
  }, [_c('div', {
    staticClass: "md-12 xl-10 xl-offset-1"
  }, [_vm._m(0), _vm._v(" "), _c('div', {
    directives: [{
