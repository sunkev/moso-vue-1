...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchProjects: function fetchProjects() {
            ...
            axios.get('/api/v1/projectitems').then(function (response) {
                _this.projects = response.data;
            });
        },
        fetchSmallProjects: function fetchSmallProjects() {
            var _this2 = this;

            axios.get('/api/v1/smallprojects').then(function (response) {
                _this2.smallprojects = response.data;
            });
        }
    }
});
            ...
            return _c(
              ...
              [
                _c("moso-project", {
                  ...
                  domProps: { innerHTML: _vm._s(project.content) }
                })
              ],
              1
            )
    ...
    _c("div", { staticClass: "row resume" }, [
      _c("div", { staticClass: "md-12 xl-10 xl-offset-1" }, [
        ...
        _c(
          ...
          _vm._l(_vm.smallprojects, function(project) {
            return _c(
              "div",
              {
                directives: [
