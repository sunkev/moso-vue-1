        ...
        <div class="row">
            <div class="lg-6">
                <div class="widget">
                    ...
                    <div class="widget__body">
                        <moso-timeline>
                            <timeline-item entry="Lead Front-End Developer" location="Indexed" time="2017 -">
            ...
            <div class="lg-6">
                <div class="widget">
                    ...
                    <div class="widget__body">
                        <moso-timeline>
                            <timeline-item entry="Webintegrator" location="Mercantec" time="2016">
                            ...
                            <timeline-item entry="IT-Supporter" location="Mercantec" time="2012">
                            ...
                            <timeline-item entry="CCNA" location="Mercantec" time="2012">
