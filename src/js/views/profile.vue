                    ...
                    <nano-tabs transparent fixed>
                        <nano-tab icon="mdi-account-circle" name="About">
                            <div class="tab-content bio">
                                ...
                                <p>That same challenge is still driving me today but in a different way. I could have built this website in any ordinary way, but I've decided to use <a href="https://vuejs.org" title="Vue.js">Vue.js</a>-components, not to make it harder but to use the technology I have in front of me. I love using new technologies and (still) try my best to keep up with the latest trends. That's why this site is made with Google's <a href="https://material.google.com/" title="Material Design">Material Design</a>.</p>

                                <p>When not coding at work, <a href="https://krve.io" title="@krve">@krve</a> and I have a project called <a href="https://getnano.io" title="Nano">Nano</a>. While there's nothing on that page but a logo, we're working creating a full-blown UI web-framework based on <a href="https://vuejs.org" title="Vue.js">Vue.js</a>-components and <a href="https://sass-lang.org" title="Sass">Sass</a>. We're not quite finished yet but if you're interested, we have a dev-branch on <a href="https://github.com/getnano/nano-framework/tree/dev" title="GitHub">GitHub</a> that you can check out and follow.
                            ...
                            <div class="tab-content tab-content--no-padding personal-information">
                            ...
                            <div class="tab-content tab-content--no-padding contact-information">
                                ...
                                <div class="column">
                                    ...
                                    <div class="column-item column-item--right">
                                        <ul class="list list--inline list--social">
                                            <li>
                                                <a href="https://github.com/moso" class="button icon-button icon-button--small" title="GitHub">
                                                    <i class="mdi mdi-github-circle"></i>
                                                    <nano-ripple></nano-ripple>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://codepen.io/moso" class="button icon-button icon-button--small" title="CodePen">
                                                    <i class="mdi mdi-codepen"></i>
                                                    <nano-ripple></nano-ripple>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://facebook.com/moso.profil" class="button icon-button icon-button--small facebook" title="Facebook">
                                                    <i class="mdi mdi-facebook"></i>
                                                    <nano-ripple></nano-ripple>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/mosodotio" class="button icon-button icon-button--small twitter" title="Twitter">
                                                    <i class="mdi mdi-twitter"></i>
                                                    <nano-ripple></nano-ripple>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="https://dk.linkedin.com/in/mosoio" class="button icon-button icon-button--small linkedin" title="LinkedIn">
                        ...
                        <nano-tab icon="mdi-file-tree" name="Projects">
                            <div class="tab-content projects">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="md-6">
                                            <moso-project image="/images/assets/nano-logo.png" name="Nano" link="https://getnano.io">
                                                <p><strong>Flex</strong>ible, mobile-first and responsive, front-end framework made with custom-made <a href="https://vuejs.org" title="Vue.js">Vue.js</a>-components and <a href="https://sass-lang" title="Sass">Sass</a>.</p>
                                            </moso-project>
                                        </div>
                                        <div class="md-6">
                                            <moso-project image="/images/assets/3up-logo.png" name="3up CDN" link="https://cdn.3up.dk">
                                                <p>A fast, global <a href="https://en.wikipedia.org/wiki/Content_delivery_network" title="content delivery network">content delivery network</a> for stuff that is published to npm. 3up is built upon FOSS technologies from <a href="https://unpkg.com" title="unpkg">unpkg</a> and works by caching the npm packages on their permanent URLs.</p>
                                            </moso-project>
                                        </div>
                                        <div class="md-6">
                                            <moso-project image="/images/assets/flexgrid-logo.png" name="Flexgrid" link="https://flexgrid.co">
                                                <p>A simple grid based on <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex" title="flexbox">flexbox</a> layout. Flexgrid is an integral part of the <a href="https://getnano.io" title="Nano">Nano</a> framework, and, if not modified, uses <a href="https://getbootstrap.com" title="Bootstrap">Bootstrap</a>'s rigid ruleset.</p>
                                            </moso-project>
                                        </div>
                                        <div class="md-6">
                                            <moso-project image="/images/assets/shade-theme.png" name="Shade Ghost theme" link="https://github.com/moso/shade-ghost-theme">
                                                <p>Theme made for my <a href="https://ghost.moso.io" title="Ghost">Ghost</a> blog. Built with Bootstrap 4 and flex, and available at the <a href="http://marketplace.ghost.org/themes/free" title="Ghost market place">Ghost market place</a> and <a href="https://github.com/moso/shade-ghost-theme" title="GitHub">GitHub</a>.</p>
                                            </moso-project>
                                        </div>
                                        <div class="md-6">
                                            <moso-project image="/images/assets/hyper-logo.png" name="hyper-arc-dark-controls" link="https://github.com/moso/hyper-arc-dark-controls">
                                                <p>Pretty window controls from the Arc Dark theme for the <a href="https://hyper.is" title="Hyper">Hyper</a> terminal.</p>
                                            </moso-project>
                                        </div>
                                        <div class="md-6">
                                            <moso-project image="/images/assets/hyper-logo.png" name="hyper-dark-scrollbar" link="https://github.com/moso/hyper-dark-scrollbar">
                                                <p>Sleek scrollbar-replacement for the <a href="https://hyper.is" title="Hyper">Hyper</a> terminal, replacing the clonky standard scrollbar with a pretty, modern one.</p>
                                            </moso-project>
                                        </div>
                                    </div>
                                </div>
